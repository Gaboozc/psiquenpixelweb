...
const StyledWrapper = styled.div`
  .button {
    ...
    &:active { outline-color: var(--yellow-400); }
    &:focus-visible { outline-color: var(--yellow-400); outline-style: dashed; }
    ...
    & > div {
      ...
      box-shadow:
        0.5px 0.5px 0 0 var(--yellow-400), 1px 1px 0 0 var(--yellow-400),
        ...
        0 0 0 4px var(--stone-50), 0.5px 0.5px 0 4px var(--stone-50),
        1px 1px 0 4px var(--stone-50), 1.5px 1.5px 0 4px var(--stone-50),
        2px 2px 0 4px var(--stone-50), 2.5px 2.5px 0 4px var(--stone-50),
        3px 3px 0 4px var(--stone-50), 3.5px 3.5px 0 4px var(--stone-50),
      ...
      & > div {
        ...
        & > div {
          ...
          &:hover { filter: drop-shadow(0 -1px 0 rgba(255, 255, 255, 0.1)); }
...
const PillButton = ({ children, onClick, href }) => {
  const inner = (
    <StyledWrapper>
